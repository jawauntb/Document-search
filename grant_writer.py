...
doc_search_answer = get_answer_from_vector(doc_search_question, llm,
                                           vector_store, chat_history)
...
agent_executor = AgentExecutor.from_agent_and_tools(agent=custom_agent,
                                                    tools=agent_tools,
                                                    verbose=True)
...
# this was jsut an example for a buddy, but can be modified for other stuff too
